...
#ifndef ASYNC_CONTINUABLEWORKITEM_HPP
#define ASYNC_CONTINUABLEWORKITEM_HPP
...
namespace Async
{
    ...
    public:
        ...
        // default constructor
        ContinuableWorkItem(Types::JobPriority priority=Types::JobPriority::OTHER) :
            WorkItem(0, priority), _successSuccessors(),
        ...
        void SetLifeSaver(IChainLinkerPtr pLifeSaver);
